        ...
        <div class="grid lg:grid-cols-[300px_minmax(400px,_0fr)] justify-center">
          ...
          <div class="grid justify-center">
            <div class="login-container">
              ...
              Username: <input style="background-color: #fff;" type="text" name="username" required><br>
              Password: <input style="background-color: #fff;" type="password" name="password" required><br>
                <input style="background-color: #A47449;" type="submit" value="Login">
              </form>
